...
function up() { decrementAxisClamped(grid, 1); }
function down() { incrementAxisClamped(grid, 1); }
function left() { decrementAxisClamped(grid, 0); }
function right() { incrementAxisClamped(grid, 0); }
